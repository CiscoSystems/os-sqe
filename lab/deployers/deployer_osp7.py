...
class DeployerOSP7(Deployer):
    ...
    def __undercloud_config(self):
        ...
        self.director_server.r_put_string_as_file_in_dir(string_to_put=undercloud_config, file_name='undercloud.conf')
    ...
    def __deploy_overcloud(self):
        ...
        self.director_server.r_put_string_as_file_in_dir(string_to_put=command, file_name='RE-DEPLOY')
    ...
    def __create_overcloud_config_and_template(self, servers):
        ...
        self.director_server.r_put_string_as_file_in_dir(string_to_put=json.dumps(config), file_name='overcloud.json')
